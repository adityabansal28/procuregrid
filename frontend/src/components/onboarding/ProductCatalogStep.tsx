...
export function ProductCatalogStep({ data, onChange, submitting, error, onBack, onSubmit }: Props) {
  ...
  const currentProductValid = data.productName.trim().length > 0 && data.imageFile !== null;
    ...
    <form className="grid gap-5 md:grid-cols-2" onSubmit={onSubmit}>
      <div className="md:col-span-2">
        <p className="text-sm text-muted-foreground">
          Add your products or services so buyers can discover you. You can add more from your
          workspace later.
        </p>
      </div>
