...
export function TrustLayer() {
  ...
  return (
    <section
      id="trust"
      className="relative overflow-hidden bg-[image:var(--gradient-hero)] py-24 text-primary-foreground"
    >
            ...
            <div className="relative rounded-2xl border border-white/15 bg-white/[0.06] p-7 backdrop-blur-xl">
              ...
              <div className="mt-7 rounded-xl bg-black/20 p-5">
                <div className="flex items-end justify-between">
                  <div>
                    <div className="text-xs uppercase tracking-wider text-white/60">
                      {t("trustLayer.card.score")}
                    </div>
                    <div className="mt-1 text-5xl font-bold tabular-nums">
                      94<span className="text-2xl text-white/40">/100</span>
                    </div>
                  </div>
